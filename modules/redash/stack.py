...
the instance",
        ...
        Default=globals()["MODULE_ENV"]["redash"]["KEY_PAIR_NAME"],
    )
)
...
inBoundPrivateNetworkAclEntry = template.add_resource(
    NetworkAclEntry(
...
inboundResponsePortsNetworkAclEntry = template.add_resource(
    NetworkAclEntry(
...
outBoundHTTPNetworkAclEntry = template.add_resource(
    NetworkAclEntry(
...
outBoundHTTPSNetworkAclEntry = template.add_resource(
    NetworkAclEntry(
...
outBoundResponsePortsNetworkAclEntry = template.add_resource(
    NetworkAclEntry(
